...
settingsSet.database = true; %Save out data in database format
...
settingsSet.refGas = {'CH4'};%Only use one at a time
...
settingsSet.podSensors = {'Fig2600','Fig2602'}; %
...
settingsSet.refPreProcess = {'removeNaNs','remove999','removeZeros','podSmooth','sortbyTime'};%

%Preprocessing functions for pod data
%If universal cal, must use "zscoreSensors"
%If ANN, can add interaction terms here
settingsSet.podPreProcess = {'podSmooth','TempC2K','humidrel2abs','removeNaNs','podTimeZone','makeDiscontTElaps','easyRbyR0'};%'zscoreSensors'

%Calibration models to fit on pod data
%If individual cal, use as many as you like
%If universal cal, can only use one
settingsSet.modelList = {'ratioSens1Te'};
...
%Only choose one
settingsSet.fieldModel = {'ratioSens1Te'};
%--------------------------------------------------------------------------};
...
settingsSet.plotsList = {}; %'originalPlot'
