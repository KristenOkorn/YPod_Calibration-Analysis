...
function podMBE = podMBE(~, Y, y_hat, valList, ~, settingsSet)
...
for kk = 1:nfolds
    ...
    podMBE(kk,1) = mean(temp_Y_cal-temp_yhat_cal);
    podMBE(kk,2) = mean(temp_Y_val-temp_yhat_val);
end
