function func = joannaNN_ratioSens1(a)
...
%Note: if telapsed included in preprocessing, will include it here too
%(i.e. no separate ratioSen1 & ratioSens1Te for an ANN)

%This is the base model for creating any artificial neural network.
switch a
    case 1; func = @joannaNN_ratioSens1fit;
    case 2; func = @joannaNN_ratioSens1Apply;
    case 3; func = @joannaNN_ratioSens1ApplyColo;
    case 4; func = @joannaNN_ratioSens1ApplyField;
end
...
%-----------------------------FIT FUNC-------------------------------------
function mdls = joannaNN_ratioSens1fit(Y,X,~)
...
%---------------------------Apply------------------------------------------
function [y_hat,eqn] = joannaNN_ratioSens1Apply(X,mdls,~)
...
function [y_hat,eqn] = joannaNN_ratioSens1ApplyColo(X,fittedMdl,~)
...
function [y_hat,eqn] = joannaNN_ratioSens1ApplyField(X_field,fittedMdl,~)
