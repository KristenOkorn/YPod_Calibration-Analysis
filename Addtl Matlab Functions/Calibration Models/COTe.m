...
switch a
    case 1; func = @COTeGen;
    case 2; func = @COTeApply;
    case 3; func = @COTeApplyColo;
    case 4; func = @COTeApplyField;
    case 5; func = @COTeReport;
end
...
%--------------------------------------------------------------------------
function mdlstruct = COTeGen(Y,X,settingsSet)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = COTeApply(X,mdlstruct,~)
...
eqn = " intercept + p1* Sensor data (CO) + p2*temp + p3*hum + p4*telapsed";

end
%--------------------------------------------------------------------------
%% Case 3 - Apply model to full colocation data
%--------------------------------------------------------------------------
function [y_hat,eqn] = COTeApplyColo(X,fittedMdl,~)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = COTeApplyField(X_field,fittedMdl,~)
