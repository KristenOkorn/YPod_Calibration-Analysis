function func = joannaNN_ratioSens2(a)
...
switch a
    case 1; func = @joannaNN_ratioSens2fit;
    case 2; func = @joannaNN_ratioSens2Apply;
    case 3; func = @joannaNN_ratioSens2ApplyColo;
    case 4; func = @joannaNN_ratioSens2ApplyField;
end
...
%-----------------------------FIT FUNC-------------------------------------
function mdls = joannaNN_ratioSens2fit(Y,X,~)
...
%---------------------------Apply------------------------------------------
function [y_hat,eqn] = joannaNN_ratioSens2Apply(X,mdls,~)
...
function [y_hat,eqn] = joannaNN_ratioSens2ApplyColo(X,fittedMdl,~)
...
function [y_hat,eqn] = joannaNN_ratioSens2ApplyField(X_field,fittedMdl,~)
