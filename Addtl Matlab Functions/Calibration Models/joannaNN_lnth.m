...
switch a
    case 1; func = @joannaNN_lnthfit;
    case 2; func = @joannaNN_lnthApply;
    case 3; func = @joannaNN_lnthApplyColo;
    case 4; func = @joannaNN_lnthApplyField;
end
...
%-----------------------------FIT FUNC-------------------------------------
function mdls = joannaNN_lnthfit(Y,X,~)

%add in the desired interaction term (location 1/4)
X.sensInteract = X.humidity.*log(X.temperature);
...
%---------------------------Apply------------------------------------------
function [y_hat,eqn] = joannaNN_lnthApply(X,mdls,~)
...
function [y_hat,eqn] = joannaNN_lnthApplyColo(X,fittedMdl,~)
...
function [y_hat,eqn] = joannaNN_lnthApplyField(X_field,fittedMdl,~)
