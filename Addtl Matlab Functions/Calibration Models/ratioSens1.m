...
switch a
    case 1; func = @ratioSens1Gen;
    case 2; func = @ratioSens1Apply;
    case 3; func = @ratioSens1ApplyColo;
    case 4; func = @ratioSens1ApplyField;
    case 5; func = @ratioSens1Report;
end
...
%--------------------------------------------------------------------------
function mdlstruct = ratioSens1Gen(Y,X,settingsSet)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = ratioSens1Apply(X,mdlstruct,~)
...
eqn = " intercept + p1*sensor1 (Fig2600) + p2*sensor2 (Fig2602) + p3*temp + p4*hum + p5*SensInteract, where SensInteract = Fig2600/Fig2602";

end
%--------------------------------------------------------------------------
%% Case 3 - Apply model to full colocation data
%--------------------------------------------------------------------------
function [y_hat,eqn] = ratioSens1ApplyColo(X,fittedMdl,~)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = ratioSens1ApplyField(X_field,fittedMdl,~)
