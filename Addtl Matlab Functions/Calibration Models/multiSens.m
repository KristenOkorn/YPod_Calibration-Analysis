...
switch a
    case 1; func = @multiSensGen;
    case 2; func = @multiSensApply;
    case 3; func = @multiSensApplyColo;
    case 4; func = @multiSensApplyField;
    case 5; func = @multiSensReport;
end
...
%--------------------------------------------------------------------------
function mdlstruct = multiSensGen(Y,X,settingsSet)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = multiSensApply(X,mdlstruct,~)
...
eqn = " intercept + p1*sensor1 + p2*sensor2 + p3*temp + p4*hum + p5*SensInteract, where SensInteract = Fig2600*Fig2602";

end
%--------------------------------------------------------------------------
%% Case 3 - Apply model to full colocation data
%--------------------------------------------------------------------------
function [y_hat,eqn] = multiSensApplyColo(X,fittedMdl,~)
...
%--------------------------------------------------------------------------
function [y_hat,eqn] = multiSensApplyField(X_field,fittedMdl,~)
