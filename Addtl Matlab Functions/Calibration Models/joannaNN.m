...
switch a
    case 1; func = @joannaNNfit;
    case 2; func = @joannaNNApply;
    case 3; func = @joannaNNApplyColo;
    case 4; func = @joannaNNApplyField;
end
...
%---------------------------Apply------------------------------------------
function [y_hat,eqn] = joannaNNApply(X,mdls,~)
...
function [y_hat,eqn] = joannaNNApplyColo(X,fittedMdl,~)
...
function [y_hat,eqn] = joannaNNApplyField(X_field,fittedMdl,~)
