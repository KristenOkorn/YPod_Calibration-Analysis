function [] = pod2database(settingsSet)
...
try
    ...
    clear col1_table_to_insert_temp SettingsSet_temp colocation1_pod_var X
        ...
        disp(['issue compiling colocation 1 data for ',current_pod_id, ' to import to database...skipping'])
end
...
try
    ...
    clear col2_table_to_insert_temp SettingsSet_temp colocation2_pod_var X
        ...
        disp(['issue compiling colocation 2 data for ',current_pod_id, ' to import to database...skipping'])
end
...
try
    ...
    clear field_table_to_insert_temp SettingsSet_temp field_pod_var X
        ...
        disp(['issue compiling field data for ',current_pod_id, ' to import to database...skipping'])
end
