function [Y,X,t] = deployLogMatch(Y,X,t,settingsSet,isField,isColo2)
...
%If this is 2ndary colo data, the reference file is 'Colocation2'
elseif isColo2
    refFileName='Colocation2';
...
for i = 1:size(deployLog,1)
    ...
    elseif strcmp(deployPod,podName) && isColo2
        %The reference file name is Colocation2 if you're analyzing
        %secondary colocation data
